...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s VGCoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  VGCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded VGCoin transaction") + "\n" +
              "  VGCoin-tx [options] -create [commands]   " + _("Create hex-encoded VGCoin transaction") + "\n" +
              "\n";
