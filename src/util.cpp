...
const char * const BITCOIN_CONF_FILENAME = "VGCoin.conf";
const char * const BITCOIN_PID_FILENAME = "VGCoind.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\VGCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\VGCoin
    // Mac: ~/Library/Application Support/VGCoin
    // Unix: ~/.VGCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "VGCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/VGCoin";
#else
    // Unix
    return pathRet / ".VGCoin";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("VGCoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The VGCoin Core developers";
    }
